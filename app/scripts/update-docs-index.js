...
const DOCUMENTATION_STRUCTURE = {
  'Core Development': {
    files: [
      ...
      { path: 'AGENT_FRONTEND.md', title: 'Agent Frontend Development', required: true },
...
Complete reference for frontend development in the Frontend App. This index provides organized access to all frontend documentation, following industry standards and best practices.
