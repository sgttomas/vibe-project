 ...
 * for the Frontend App. Checks both .env.local and process.env
...
function validateEnvironment() {
  console.log('🔍 Environment Validation for Frontend App\n');
...
function showSetupInstructions() {
  ...
  console.log('   NEXT_PUBLIC_APP_NAME=Frontend App');
